...
public class Constants {
	...
	public static final String GEN_CONFIG_PATH = "config/gen-config.xml";
	...
	public static final String FILE_HS = ".settings/config.properties";
	public static final String FOLDER_HS = ".settings";
	...
	public static final String EXTENSION_SQLMAP = "-mapping.xml";
