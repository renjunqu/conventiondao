...
public class TypeHandlerFactory {
  ...
  public void putTypeAlias(String alias, String value) {
    ...
    if (typeAliases.containsKey(key) && !typeAliases.get(key).equals(value)) {
      throw new RuntimeException("Error in XmlSqlMapClientBuilder.  Alias name conflict occurred.  The alias '" + key + "' is already mapped to the value '" + typeAliases.get(alias) + "'.");
    }
